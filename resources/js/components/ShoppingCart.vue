            ...
            <tbody>
                <template v-for="(product, index) in products" v-bind:key="product.id">
                    <tr>
                        ...
                        <span class="text-sm lg:text-base font-medium" v-text="product.price / 100"></span>
                        </td>
                        <td class="text-right">
                        <span class="text-sm lg:text-base font-medium" v-text="(product.price * product.quantity) / 100">
                        </span>
                        </td>
                    </tr> 
                </template>
